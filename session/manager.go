...
func (m *Manager) GetSession(ctx *gweb.Context) (Session, error) {
...
func (m *Manager) InitSession(ctx *gweb.Context, id string) (Session, error) {
...
func (m *Manager) RefreshSession(ctx *gweb.Context) (Session, error) {
...
func (m *Manager) RemoveSession(ctx *gweb.Context) error {
	sess, err := m.GetSession(ctx)
	if err != nil {
		return err
	}
